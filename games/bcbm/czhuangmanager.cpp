...
CZhuangManager::CZhuangManager()
	:m_curZhuangId(-1),m_minShangZhuangMoney(10),m_g_myselfRoom(NULL),m_totalShangZhuangCount(10),m_curShangZhuangCount(0),
...
CZhuangManager::CZhuangManager(Room *proom)
	:m_curZhuangId(-1),m_minShangZhuangMoney(10),m_g_myselfRoom(proom),m_totalShangZhuangCount(10),m_curShangZhuangCount(0),
	m_ShangZhuangGamingResult(0)
{
